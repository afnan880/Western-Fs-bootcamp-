...
const SEED_PLAYERS: Player[] = [
  { id: 1, name: 'Amara Osei', ranking: 1, level: 'Advanced', wins: 24, losses: 6 },
  { id: 2, name: 'Liam Fitzgerald', ranking: 2, level: 'Advanced', wins: 21, losses: 9 },
  { id: 3, name: 'Priya Nair', ranking: 3, level: 'Advanced', wins: 19, losses: 8 },
  { id: 4, name: 'Diego Salazar', ranking: 4, level: 'Intermediate', wins: 16, losses: 11 },
  { id: 5, name: 'Hana Kobayashi', ranking: 5, level: 'Intermediate', wins: 15, losses: 12 },
  { id: 6, name: 'Marcus Webb', ranking: 6, level: 'Intermediate', wins: 13, losses: 14 },
  { id: 7, name: 'Sofia Moretti', ranking: 7, level: 'Intermediate', wins: 12, losses: 10 },
  { id: 8, name: 'Afnan Mudassar', ranking: 8, level: 'Advanced', wins: 18, losses: 7 },
  { id: 9, name: 'Ravi Chandran', ranking: 9, level: 'Beginner', wins: 6, losses: 9 },
  { id: 10, name: 'Emily Nguyen', ranking: 10, level: 'Beginner', wins: 5, losses: 8 },
  { id: 11, name: 'Tom Reilly', ranking: 11, level: 'Beginner', wins: 4, losses: 10 },
  { id: 12, name: 'Zara Ahmed', ranking: 12, level: 'Beginner', wins: 3, losses: 7 }
]
